  ...
  <table>
    ...
    <tr>
      <td width="300">
        ...
        <p>3) 후기글들은 최신순으로 정렬됩니다.</p>
        <p>4) 후기글 작성자는 이름의 일부가 *로 가려져서 표시됩니다.</p>
      </td>
      <td width="700">
        <img src=""/>
      </td>
    ...
    <tr>
      <td width="300">
        ...
        <p>2) 상품문의의 경우, 모든 글들을 아코디언으로 펼쳐볼 수 있습니다.</p>
        <p>3) 문의글들은 최신순으로 정렬됩니다.</p>
        <p>4) 문의글 작성자는 이름의 일부가 *로 가려져서 표시됩니다.</p>
      </td>
      <td width="700">
        <img src=""/>
      </td>
    ...
    <tr>
      <td width="300">
        <h4>:round_pushpin: 상품문의 - 비밀글</h4>
        <h4>:round_pushpin:기능 설명</h4>
        <p>1) 자신이 쓴 비밀글은 확인할 수 있습니다.</p>
        <p>2) 비밀글에 접근하려고 했을때는 "비밀글입니다."라고 경고창이 뜹니다.</p>
      </td>
      <td width="700">
        <img src=""/>
      </td>
    ...
    <tr>
      <td width="300">
        ...
        <p>2) 현재 탱탱쫄면 페이지에서 문의글을 작성하고 있습니다. 탱탱쫄면 페이지에서 작성했다는걸 예시로 쉽게 이해시켜드리기 위해 제목에 탱탱쫄면이라고 넣었습니다. 탱탱쫄면에서 작성한 이 문의글은 유부호 만두페이지에서는 볼 수 없는걸 확인할 수 있습니다.
        </p>
      </td>
      <td width="700">
        <img src=""/>    
